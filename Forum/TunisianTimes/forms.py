...
class ProfilePageForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            # 'profile_pic':forms.TextInput(attrs={'class':'form-control','placeholder':'Enter your title'}),
            'bio': forms.Textarea(attrs={'class': 'form-control', 'placeholder': 'Enter your snippet here'}),
            ...
            'insta_url': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Enter content here'}),
            'linkedin_url': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Enter content here'}),
        }
...
class EditProfileForm(UserChangeForm):
    ...
    class Meta:
        model = User
        # knew all this field after inspecting in the edit profile page
